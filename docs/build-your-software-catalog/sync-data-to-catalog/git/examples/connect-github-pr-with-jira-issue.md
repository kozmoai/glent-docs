...
- Ensure you have [Jira installed and configured in your environment](https://docs.useglint.io/build-your-software-catalog/sync-data-to-catalog/jira/)
...
:::info Note
For the GitHub app installation you will need to have a registered organization in Glint and your Glint user role must be set to `Admin` (see [prerequisites](#connect-github-pull-request-with-jira-issue)).
...
## Integrate Jira into Glint

The goal of this section is to bring our Jira issues into Glint. [Glint's Jira integration](https://docs.useglint.io/build-your-software-catalog/sync-data-to-catalog/jira/) (powered by [Ocean](https://ocean.useglint.io/)) allows you to import `projects` and `issues` from your Jira account into Glint. The integration automatically creates <GlintTooltip id="blueprint">blueprints</GlintTooltip> and <GlintTooltip id="entity">entities</GlintTooltip> for these resources.
...
1. Install Glint's Jira integration using Helm, by running the command below in your terminal.
...
helm upgrade --install my-jira-integration kozmoai/glint-ocean \
	--set glint.clientId="GLINT_CLIENT_ID"  \  # REPLACE VALUE
	--set glint.clientSecret="GLINT_CLIENT_SECRET"  \  # REPLACE VALUE
...
- Go to your [Builder](https://app.useglint.io/dev-portal/data-model), you should now see four new <GlintTooltip id="blueprint">blueprints</GlintTooltip> created by the integration - `Jira Project` and `Jira Issue`.
- Go to your [Software catalog](https://app.useglint.io/services), click on `Jira Issue` in the sidebar, you should now see new <GlintTooltip id="entity">entities</GlintTooltip> created for all your Jira issues

## Create the Jira Issue relation

Now that Glint is synced with our Jira resources, let's map the Jira issues to the Github pull requests.
...
Now that the <GlintTooltip id="blueprint">blueprints</GlintTooltip> are related, we need to assign the relevant Jira Issue to each of our pull requests. This can be done by adding some mapping logic. Go to your [data sources page](https://app.useglint.io/dev-portal/data-sources), and click on your Github integration:
...
| ------------------------------------------- | ----------- |
| GLINT-4837 \| This is the evening of the day | GLINT-4837   |
...
- [Glint's Jira integration](https://docs.useglint.io/build-your-software-catalog/sync-data-to-catalog/jira/)
