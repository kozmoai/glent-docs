...
In this [live demo](https://demo.useglint.io/dev-portal) example, we can see the DevPortal Builder page with all of the blueprints and their relations. 🎬
...
In this [live demo](https://demo.useglint.io/packageVersionEntity?identifier=AnalyticsTracker_1_2_9) example, we can see a specific package version and its related core packages. 🎬
...
In this [live demo](https://demo.useglint.io/developerEnvEntity?identifier=test-shizuko) example, we can see a specific developer environment and the running services it uses. 🎬
...
1. Go to the [Builder page](https://app.useglint.io/dev-portal) of your portal.
