...
In this tutorial, we will export pull requests from GitHub and create matching Glint Entities!

1. Create a `pullRequest` Blueprint and `glint-app-config.yml` configuration file.

To export your GitHub `Pull Requests` to Glint, you can use the following Glint Blueprints definitions, and `glint-app-config.yml`:
