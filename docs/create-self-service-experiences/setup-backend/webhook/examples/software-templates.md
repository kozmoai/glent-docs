...
:::tip
All relevant files and resources for this guide are available [**Here for GitHub**](https://github.com/kozmoai/glint-cookiecutter-example), and [**Here for GitLab**](https://github.com/kozmoai/glint-cookiecutter-gitlab-example).
:::

## Example - create a new service repository

The following example utilizes Glint [webhook-actions](/build-your-software-catalog/custom-integration/webhook) to create a new service repository from a software template.
...
A full example with a backend, can be found [here for GitHub](https://github.com/kozmoai/glint-cookiecutter-example) or [here for GitLab](https://github.com/kozmoai/glint-cookiecutter-gitlab-example).

:::info
The above example also creates a new Service entity in Glint, and updates the action run details.
...
Using Glint Self-Service Actions, you can conveniently create and record new projects from public or private templates.
