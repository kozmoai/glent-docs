...
In this guide, we will create a self-service action in Glint that executes a GitHub workflow to promote an image from staging to production. 
...
<details>
  ...
  <summary>Glint Action: Promote Deployment</summary>
   :::tip
