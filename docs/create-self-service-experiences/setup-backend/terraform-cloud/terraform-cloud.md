...
Glint's Terraform Cloud Action can trigger
...
![Glint Kafka Architecture](../../../../static/img/self-service-actions/setup-backend/terraform-cloud/terraform-cloud-agent-architecture.png)
...
3. Glint's execution agent pulls the new trigger event from your Kafka topic, and triggers your Terraform Cloud run.
...
- [Install the Glint execution agent to trigger the Terraform Cloud Run](#Installation).
