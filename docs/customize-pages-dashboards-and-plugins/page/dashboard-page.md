...
:::info Glint Pulumi
See all the supported variables in the Glint Pulumi [documentation](https://www.pulumi.com/registry/packages/glint/api-docs/page/#create)
:::

**Introduction**

This guide walks you through creating custom pages using our [Pulumi provider](https://www.pulumi.com/registry/packages/glint/). We'll cover:
...
1. Basic Glint Concepts: Familiarity with <GlintTooltip id="blueprint">blueprints</GlintTooltip>, <GlintTooltip id="entity">entities</GlintTooltip>, and <GlintTooltip id="dataset">datasets</GlintTooltip> in your Glint system is helpful.
2. You will also need your [Glint credentials](https://docs.useglint.io/build-your-software-catalog/custom-integration/api/#find-your-glint-credentials).
3. This guide also assumes that you have installed Pulumi, and [the Glint provider's SDK](https://www.pulumi.com/registry/packages/glint/installation-configuration/) in your chosen lanaguage.
...
dashboard_layout = {
    "id": "myDashboardWidget",  # This is optional, as Glint can auto-generate IDs
...
3. Now we can define the page and run `pulumi up` to create the page in Glint.
<details>
...
4. Let us now add helper functions to create <GlintTooltip id="dataset">dataset</GlintTooltip> dependent widgets.

:::tip
If you have not already, we recommend [installing](/build-your-software-catalog/sync-data-to-catalog/git/github/installation) the GitHub app in order to get some data into your Glint account. Subsequently, you can use the blueprints from this [guide](/build-your-software-catalog/sync-data-to-catalog/git/github/examples#mapping-repositories-file-contents-and-pull-requests) and follow along for tangible results.
:::
...
# Dataset configuration: `service` is the name of the blueprint in Glint
...
export const microserviceDashboardPage = new glint.Page(
  "microservice-overview-page-resource",
  {
    identifier: "microservice_overview_page",
    title: "Microservices Dashboard",
