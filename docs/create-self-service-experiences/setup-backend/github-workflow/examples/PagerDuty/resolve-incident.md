...
This GitHub action allows you to quickly resolve incident in PagerDuty via Glint Actions with ease.
...
<details>
  ...
  <summary>Glint Action: Resolve Incident</summary>
   :::tip
...
Congrats 🎉 You've successfully resolved an incident in PagerDuty from Glint!