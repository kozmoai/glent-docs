...
In the following guide, you are going to create a self-service action in Glint that executes a [GitHub workflow](https://docs.useglint.io//create-self-service-experiences/setup-backend/github-workflow) to add tags to a [storage account](https://learn.microsoft.com/en-us/azure/storage/common/storage-account-overview).

## Prerequisites
1. This guide assumes that you already have a blueprint for an Azure Storage account with some resources. If you haven't done so yet, create the blueprint by referring to this [guide](https://docs.useglint.io/create-self-service-experiences/setup-backend/github-workflow/examples/azure/create-azure-resource) first.
2. Prior knowledge of Glint Actions is essential for following this guide. Learn more about them [here](https://docs.useglint.io/create-self-service-experiences/setup-ui-for-action/).
...
1. Create the following GitHub Action secrets:
    1. Create the following Glint credentials:
        1. `GLINT_CLIENT_ID` - Glint Client ID [learn more](https://docs.useglint.io/build-your-software-catalog/custom-integration/api/#get-api-token).
        2. `GLINT_CLIENT_SECRET` - Glint Client Secret [learn more](https://docs.useglint.io/build-your-software-catalog/custom-integration/api/#get-api-token).
...
<details>
  ...
  <summary>Glint Action: Add Tags to Azure Storage</summary>
   :::tip
