...
const FeatureList: FeatureItem[] = [
  {
    ...
    Svg: require("@site/static/img/glint_code_icon.svg").default,
    description: (
      <>Quickly learn what Glint is all about and how to get started.</>
    ),
  },
  {
    title: "All of Your Questions Answered",
    Svg: require("@site/static/img/glint_box_icon.svg").default,
    description: (
      <>
  ...
  },
  {
    ...
    Svg: require("@site/static/img/glint_flower_icon.svg").default,
