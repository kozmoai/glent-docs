...
In the following guide, we are going to create a self-service action in Glint that executes a GitHub workflow to nudge PR reviewers with a kind message.
...
<details>
  ...
  <summary>Glint Action: Nudge Pull Request Reviewers</summary>
   :::tip
...
5. Trigger the action from the [self-service](https://app.useglint.io/self-serve) page of your Glint application.
