...
This is done in the first two tabs of the action creation form in Glint's UI:
...
- **Create** - the action will result in the creation of a new <GlintTooltip id="entity">entity</GlintTooltip> in Glint by triggering a provisioning process in your infrastructure. Since these actions create a new entity, they are not tied to an existing entity in your software catalog.
...
Glint allows you to create a wizard-like experience for your developers by utilizing a variety of input types they will need to fill, while also including input validations.  
