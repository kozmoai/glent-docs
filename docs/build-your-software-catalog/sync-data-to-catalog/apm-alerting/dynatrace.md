...
Our Dyantrace integration allows you to import `problem`, `slo`, and `entity` resources from your Dynatrace instance into Glint, according to your mapping and definition.
...
helm upgrade --install my-dynatrace-integration kozmoai/glint-ocean \
...
The integration configuration determines which resources will be queried from Dynatrace, and which entities and properties will be created in Glint.
...
- The `glint`, `entity` and the `mappings` keys are used to map the Dynatrace object fields to Glint entities. To create multiple mappings of the same kind, you can add another item in the `resources` array:
  ...
  resources:
    - kind: entity
      ...
      glint:
        # highlight-start
        entity:
          mappings: # Mappings between one Dynatrace object to a Glint entity. Each value is a JQ query.
            identifier: .entityId
            title: .displayName
            blueprint: '"dynatraceEntity"'
            properties:
...
5. Configure the notification using the following details.
   ...
   2. `Display name` - use a meaningful name such as Glint Ocean Webhook.
...
<details>
<summary>Entity entity in Glint</summary>
...
<details>
<summary>Problem entity in Glint</summary>
...
<details>
<summary>SLO entity in Glint</summary>
