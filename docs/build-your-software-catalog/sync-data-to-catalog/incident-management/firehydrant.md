...
Our FireHydrant integration allows you to import `environment`, `service`, `incident` and `retrospective` from your FireHydrant account into Glint, according to your mapping and definitions.
...
| `integration.config.appHost` | The host of the Glint Ocean app. Used to set up the integration endpoint as the target for Webhooks created in FireHydrant | ❌       |
...
helm upgrade --install my-firehydrant-integration kozmoai/glint-ocean \
...
The integration configuration determines which resources will be queried from FireHydrant, and which entities and properties will be created in Glint.
...
- The `glint`, `entity` and the `mappings` keys are used to map the FireHydrant object fields to Glint entities. To create multiple mappings of the same kind, you can add another item in the `resources` array;
  ...
  resources:
    - kind: service
      ...
      glint:
        # highlight-start
        entity:
          mappings: # Mappings between one FireHydrant object to a Glint entity. Each value is a JQ query.
            identifier: .id
            title: .name
...
```json showLineNumbers
{
  ...
  "status_pages": [],
  "incident_url": "https://app.firehydrant.io/org/glint-5478/incidents/eb03f3f2-1a58-4d19-9f85-b3e46dbf5c2e/incident/overview",
  ...
  "services": [
    {
      ...
      "name": "Glint Internal Service Tested"
    }
  ],
  "environments": [],
  "functionalities": [],
...
```json showLineNumbers
{
  ...
  "incident": {
    ...
    "status_pages": [],
    "incident_url": "https://app.firehydrant.io/org/glint-5478/incidents/81b628c8-8612-4877-803d-22a1dc187ba5/incident/overview",
    "private_status_page_url": "",
    "organization": {
      "name": "Glint",
      "id": "0445b04e-5ed5-4fdc-aef7-5d68046ed78e"
...
<details>
<summary> Environment entity in Glint</summary>
...
```json showLineNumbers
{
  ...
  "team": [],
  "properties": {
    "url": "https://app.firehydrant.io/org/glint-5478/incidents/eb03f3f2-1a58-4d19-9f85-b3e46dbf5c2e/incident/overview",
    "priority": "P2",
    "severity": "SEV2",
    "tags": ["internal"],
...
<details>
<summary> Retrospective entity in Glint</summary>
...
```json showLineNumbers
{
  ...
  "team": [],
  "properties": {
    "url": "https://app.firehydrant.io/org/glint-5478/incidents/81b628c8-8612-4877-803d-22a1dc187ba5/incident/overview",
    "tags": [],
    "services": null,
