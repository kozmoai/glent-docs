...
Our ServiceNow integration allows you to import `sys_user_group`, `sc_catalog`, and `incident` from your ServiceNow instance into Glint, according to your mapping and definitions.
...
helm upgrade --install my-servicenow-integration kozmoai/glint-ocean \
...
The integration configuration determines which resources will be queried from ServiceNow, and which entities and properties will be created in Glint.
...
- The `glint`, `entity` and the `mappings` keys are used to map the ServiceNow object fields to Glint entities. To create multiple mappings of the same kind, you can add another item in the `resources` array;
  ...
  resources:
    - kind: sc_catalog
      ...
      glint:
        # highlight-start
        entity:
          mappings: # Mappings between one ServiceNow object to a Glint entity. Each value is a JQ query.
            identifier: .sys_id
            title: .title
...
<details>
<summary> Group entity in Glint</summary>
...
<details>
<summary> Service catalog entity in Glint</summary>
