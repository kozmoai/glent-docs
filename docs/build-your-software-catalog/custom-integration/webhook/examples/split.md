...
In this example you are going to create a webhook integration between [Split](https://www.split.io/) and Glint, which will ingest impressions.
...
1. **Basic details** tab - fill the following details:
   ...
   3. Description : `A webhook configuration to map Splitio impressions to Glint`;
   4. Icon : `Jenkins`;
...
Done! any time an impression is triggered, the webhook will send the data to Glint and create a new `split impression` entity
