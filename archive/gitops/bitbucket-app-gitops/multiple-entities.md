...
By default, we search for all `glint.yml` files in your repo:

![Bitbucket app tree of glint.yml files](../../../../../static/img/integrations/common/TreeOfGlintYamlFiles.png)
