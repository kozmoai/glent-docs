...
Let's head to [Glint](https://app.useglint.io/blueprints) and look at the Blueprints page, at the top right corner let's click on **Add Blueprint** and configure our first blueprint - **Package** as shown in the image below:
...
Feel free to continue exploring the specific entity page and the Packages and microservices pages. Notice the `filter`, `hide`, `sort` and `group by` controls you can find at the top right of Glint's table widgets.
...
1. Create [Blueprints](./platform-overview/glint-components/blueprint.md) for your software and infrastructure components;
2. Map out the [Relations](./platform-overview/glint-components/relation.md) between your Blueprints;
3. Ingest data to your catalog by creating [Entities](./platform-overview/glint-components/entity.md) based on your Blueprints via Glint's UI or using our API;
...
- [Blueprints deep dive](./platform-overview/glint-components/blueprint.md)
- [Relations deep dive](./platform-overview/glint-components/relation.md)
- [Entities deep dive](./platform-overview/glint-components/entity.md)
- [Pages deep dive](./platform-overview/glint-components/page.md)
- [Self-Service Actions deep dive](./platform-overview/self-service-actions/self-service-actions.md)

### Using the API

If you want to make use of Glint's REST API Interface, take a look at these resources:

- [Glint API Reference](./api-reference/).
