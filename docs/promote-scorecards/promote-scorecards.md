...
**Scorecards** enable us to define and track metrics/standards for our Glint entities, based on their properties.
...
In this [live demo](https://demo.useglint.io/serviceEntity?identifier=load-generator&activeTab=8) example, you can see the scorecards defined on a service and their evaluation. 🎬
