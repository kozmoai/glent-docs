...
This GitHub action allows you to quickly create a service in PagerDuty via Glint with ease.
...
Congrats 🎉 You've created your first `service` in PagerDuty from Glint!