...
This example demonstrates how to quickly scaffold Azure DevOps repositories using a [Cookiecutter Template](https://www.cookiecutter.io/templates) via Glint Actions.
...
2. Create a Glint blueprint with the following JSON definition:
        ...
        steps:
          ...
          - script: |
              curl -X POST \
                ...
                "https://api.useglint.io/v1/blueprints/${{ variables.BLUEPRINT_ID }}/entities?upsert=true&run_id=${{ variables.RUN_ID }}&create_missing_related_entities=true"
        ...
        steps:
          ...
          - script: |
              curl -X PATCH \
                ...
                "https://api.useglint.io/v1/actions/runs/${{ variables.RUN_ID }}"
