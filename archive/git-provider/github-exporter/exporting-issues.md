...
In this tutorial, we will export issues from GitHub and create matching Glint Entities!

1. Create an `issue` Blueprint and `glint-app-config.yml` configuration file.

To export your GitHub `Issues` to Glint, you can use the following Glint Blueprint definition, and `glint-app-config.yml`:
...
Now you can view and query all of your Issues as Glint Entities!
