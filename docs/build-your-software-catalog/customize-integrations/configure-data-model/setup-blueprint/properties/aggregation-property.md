...
- `query` - **Optional** - The query that will be performed on the target blueprint. The query is based on the Filters to include or exclude specific data based on Glint's [Search Rules](/search-and-query/search-and-query.md#rules)
...
The query is based on the Filters to include or exclude specific data based on Glint's [Search Rules](/search-and-query/search-and-query.md#rules)
