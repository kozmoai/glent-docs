...
Using Glint's Kubernetes Exporter, you can keep track of all Flux resources in your cluster and export
monitored repositories and applications to Glint. You will use built in metadata from your kubernetes resources and CRDs to create entities in
...
use [this file](https://github.com/kozmoai/template-assets/blob/main/kubernetes/blueprints/fluxcd-blueprints.json) to
define your blueprints. Do this by running:

```bash showLineNumbers
export CUSTOM_BP_PATH="https://github.com/kozmoai/template-assets/blob/main/kubernetes/blueprints/fluxcd-blueprints.json"
```
...
In this use-case you will be using the **[this configuration file](https://github.com/kozmoai/template-assets/blob/main/kubernetes/templates/fluxcd-kubernetes_v1_config.yaml)**. To achieve this, run:

```bash showLineNumbers
export CONFIG_YAML_URL="https://github.com/kozmoai/template-assets/blob/main/kubernetes/templates/fluxcd-kubernetes_v1_config.yaml"
```
...
You can now browse to your Glint environment to see that your blueprints have been created, and your k8s and Flux
