...
This page contains a list of Glint's available integrations, organized by the platform/product.
...
- [Script to ingest GitHub packages](https://github.com/kozmoai/example-github-packages)
...
- [Webhook integration between Bitbucket (self-hosted) server and Glint](/build-your-software-catalog/custom-integration/webhook/examples/bitbucket-server.md)
...
- [Mapping resources using Glint CRDs](/build-your-software-catalog/sync-data-to-catalog/git/gitops-using-glint-crd.md)
...
- [Glint entity CRD](/build-your-software-catalog/sync-data-to-catalog/kubernetes/glint-crd.md)
...
- [Terraform manage S3 buckets lifecycle](/build-your-software-catalog/sync-data-to-catalog/iac/terraform/examples/s3-bucket.md)
- [Terraform manage developer environment](/build-your-software-catalog/sync-data-to-catalog/iac/terraform/examples/create-dev-env.md)
- [Script to ingest ECR Images and Repositories](https://github.com/kozmoai/example-ecr-images)
...
- [Script to ingest GCR Images and Repositories](https://github.com/kozmoai/example-gcr-images)
...
- [Self service for a new PagerDuty incident using GitHub workflows](https://github.com/kozmoai/self-service-actions-examples/tree/main/github-workflows/pagerduty)
...
- [Self service for a new Jira bug using GitHub workflows](https://github.com/kozmoai/self-service-actions-examples/tree/main/github-workflows/jira)
...
- [Jenkins webhook integration with Glint](/build-your-software-catalog/custom-integration/webhook/examples/jenkins.md)
...
- [Script to ingest JFrog X-ray alerts, repositories and artifacts](https://github.com/kozmoai/example-jfrog-xray-alerts)
- [Script to ingest JFrog container image builds and repositories](https://github.com/kozmoai/example-jfrog-container-images)
