...
In this example you are going to create a webhook integration between [GitLab](https://about.gitlab.com/) and Glint, which will ingest merge request entities.
...
1. **Basic details** tab - fill the following details:
   ...
   3. Description : `A webhook configuration to map Gitlab merge requests to Glint`;
   4. Icon : `Gitlab`;
...
Done! any change you make to a merge request (open, close, edit, etc.) will trigger a webhook event that GitLab will send to the webhook URL provided by Glint. Glint will parse the events according to the mapping and update the catalog entities accordingly.
...
```json showLineNumbers
{
  ...
  "project": {
    ...
    "web_url": "https://gitlab.com/useglint-labs/datadog-service-dependency-example",
    "namespace": "kozmoai",
    "default_branch": "main",
    "homepage": "https://gitlab.com/useglint-labs/datadog-service-dependency-example",
    "url": "git@gitlab.com:useglint-labs/datadog-service-dependency-example.git"
  },
  "object_attributes": {
    "assignee_id": 6152768,
    "author_id": 6152768,
    ...
    "url": "https://gitlab.com/useglint-labs/datadog-service-dependency-example/-/merge_requests/1",
    "source": {
      "id": 46155864,
      "name": "Datadog Service Dependency Example",
      "default_branch": "main",
    ...
    "last_commit": {
      ...
      "url": "https://gitlab.com/useglint-labs/datadog-service-dependency-example/-/commit/8bca1b72fc7d18d77d3e48f8d3b332165ff94898",
      "author": {
        "name": "username",
...
```json showLineNumbers
{
  ...
  "properties": {
    ...
    "lastChangeType": "open",
    "repositoryUrl": "https://gitlab.com/useglint-labs/datadog-service-dependency-example",
    "sourceBranch": "webhook",
    "targetBranch": "main",
    "mergeRequestUrl": "https://gitlab.com/useglint-labs/datadog-service-dependency-example/-/merge_requests/1",
    "lastCommitUrl": "https://gitlab.com/useglint-labs/datadog-service-dependency-example/-/commit/8bca1b72fc7d18d77d3e48f8d3b332165ff94898",
    "projectName": "Datadog Service Dependency Example",
    "projectUrl": "https://gitlab.com/useglint-labs/datadog-service-dependency-example",
    "labels": [
      {
        "id": 30672355,
        "title": "Infra",
