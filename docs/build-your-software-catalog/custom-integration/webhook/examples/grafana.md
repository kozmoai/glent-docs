...
In this example you are going to create a webhook integration between [Grafana](https://grafana.com/) and Glint, which will ingest alert entities.
...
1. **Basic details** tab - fill the following details:
   ...
   3. Description : `A webhook configuration to map Grafana alerts to Glint`;
   4. Icon : `Grafana`;
...
5. Go to **Notification policies** and add the Glint Webhook contact point to your **Default policy** and be notified of any alert in Grafana;
...
Done! any change that happens to your alerts in Grafana will trigger a webhook event to the webhook URL provided by Glint. Glint will parse the events according to the mapping and update the catalog entities accordingly.
