...
In this example you will create blueprints for `ciJob` and `image` entities, and a relation between them. Then you will add some Python code to create new entities in Glint every time the Gitlab Pipeline is triggered:
