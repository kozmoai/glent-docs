...
In this example you are going to export some generic information about a GCP organization and all of its assets, to Glint.
...
After running `terraform apply` you will see the organization, folders, projects, and `gcpAssets` entities in Glint.
