...
<details>
    <summary>Installing Glint's Jira integration</summary>

We will be using Glint's Jira issue to connect our Jira data to our Github data.
To install Glint's Jira integration, run the fo
