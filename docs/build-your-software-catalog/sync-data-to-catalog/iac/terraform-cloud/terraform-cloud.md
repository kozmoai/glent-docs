...
description: Terraform integration in Glint
---
...
The Terraform Cloud Integration for Glint enables seamless import and synchronization of `organizations`, `projects`, `workspaces`, `runs`, and `state versions` from your Terraform infrastructure management into Glint. This integration allows you to effectively monitor and manage your Terraform Cloud workspaces and runs within the Glint platform.
...
- Synchronization of Infrastructure Management: Automatically synchronize workspace, run and state version data from Terraform Cloud into Glint for centralized tracking and management.
...
helm upgrade --install terraform kozmoai/glint-ocean \
...
The integration configuration determines which resources will be queried from Terraform Cloud, and which entities and properties will be created in Glint.
...
- The `glint`, `entity` and the `mappings` keys are used to map the Terraform Cloud object fields to Glint entities. To create multiple mappings of the same kind, you can add another item in the `resources` array;
...
<details>
<summary> organization entity in Glint</summary>
...
```json showLineNumbers
{
  ...
  "properties": {
    ...
    "ownerEmail": "example@useglint.io",
    "planExpired": "false",
...
<details>
<summary> workspace entity in Glint</summary>
...
<details>
<summary> Run entity in Glint</summary>
...
<details>
<summary> State Version in Glint</summary>
