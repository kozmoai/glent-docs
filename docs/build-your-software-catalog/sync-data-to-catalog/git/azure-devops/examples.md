...
import GlintAppConfig from './\_azuredevops_exporter_example_glint_app_config.mdx'
...
import GlintPipelineAppConfig from './example-pipeline/\_azuredevops_exporter_example_pipeline_glint_app_config.mdx'
...
import GlintTeamsAppConfig from './example-teams/\_azuredevops_exporter_example_teams_glint_app_config.mdx'

# Examples

## Mapping repositories, file contents, repository policies and pull requests

In the following example you will ingest your Azure Devops repositories, their README.md file contents and pull requests to Glint, you may use the following Glint blueprint definitions and integration configuration:
...
- We leverage [JQ JSON processor](https://stedolan.github.io/jq/manual/) to map and transform Azure Devops objects to Glint entities.
...
After creating the blueprints and saving the integration configuration, you will see new entities in Glint matching your repositories alongside their `README.md` file contents and pull requests.

## Mapping pipelines

In the following example you will ingest your Azure Devops pipelines to Glint, you may use the following Glint blueprint definitions and integration configuration:

<PipelineBlueprint/>

<GlintPipelineAppConfig/>
...
After creating the blueprints and saving the integration configuration, you will see new entities in Glint.


## Mapping teams and members

In the following example you will ingest your Azure Devops teams and their members to Glint, you may use the following Glint blueprint definitions and integration configuration:
...
After creating the blueprints and saving the integration configuration, you will see new entities in Glint matching your teams alongside their members.

## Mapping supported resources

The above examples shows a specific use cases, but Glint's Azure Devops integration supports the ingestion of many other Azure Devops objects, to adapt the examples above, use the Azure Devops API reference to learn about the available fields for the different supported objects:
