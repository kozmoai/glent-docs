...
In this [live demo](https://demo.useglint.io/k8s-clusters) example, we can see the `Cloud Provider` Property which is a mirror property of the related `Cloud Account` blueprint 🎬
...
This is a mirror property created from one of Glint's [meta-properties](./meta-properties.md) on the `target` blueprint.
