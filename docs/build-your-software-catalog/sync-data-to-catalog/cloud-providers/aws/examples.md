...
In this step-by-step example, you will export your `ECS clusters` and `ECS services` to Glint.

1. Create the following Glint blueprint:
...
2. Upload the `config.json` file to the exporter's S3 bucket:
   ...
   <details>
   <summary> Glint AWS exporter config.json </summary>
...
4. Optional: Create an event rule to trigger automatic syncing of changes in ECS clusters and ECS services.
   ...
   Description: The template used to create event rules for the Glint AWS exporter.
   Parameters:
     GlintAWSExporterStackName:
       Description: Name of the Glint AWS exporter stack name
       Type: String
       MinLength: 1
       MaxLength: 255
       AllowedPattern: ^[a-zA-Z][-a-zA-Z0-9]*$
       Default: serverlessrepo-glint-aws-exporter
   Resources:
     EventRule0:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-ecs-cluster-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
               Fn::ImportValue:
                 Fn::Sub: ${GlintAWSExporterStackName}-EventsQueueARN
             InputTransformer:
               InputPathsMap:
     ...
     EventRule1:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-ecs-service-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your `App Runner services` to Glint.
     ...
     EventRule0:
       ...
       Properties:
         ...
         EventPattern:
           ...
           source:
             - aws.apprunner
         Name: glint-aws-exporter-sync-apprunner-events
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your `Lambda functions` to Glint.
   ...
   Resources:
     EventRule0:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-lambda-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your `SNS topics` and `SQS queues` to Glint.

1. Create the following Glint blueprints:
         ...
         EventPattern:
           ...
           detail:
             ...
             eventName:
               ...
               - prefix: UntagResource
               - prefix: DeleteTopic
         Name: glint-aws-exporter-sync-sns-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
         ...
         EventPattern:
           ...
           detail:
             ...
             eventName:
               ...
               - prefix: UntagQueue
               - prefix: DeleteQueue
         Name: glint-aws-exporter-sync-sqs-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your `S3 buckets` to Glint.
          ...
          EventPattern:
            ...
            detail:
              ...
              eventName:
                ...
                - prefix: PutBucket
                - prefix: DeleteBucket
          Name: glint-aws-exporter-sync-s3-trails
          State: ENABLED
          Targets:
            - Id: GlintAWSExporterEventsQueue
              Arn:
...
In this step-by-step example, you will export your `API Gateway APIs` to Glint.
    ...
    Resources:
      EventRule0:
        ...
        Properties:
          ...
          Name: glint-aws-exporter-sync-apigateway-restapi-trails
          State: ENABLED
          Targets:
            - Id: GlintAWSExporterEventsQueue
              Arn:
          ...
          EventPattern:
            ...
            detail:
              ...
              eventName:
                ...
                - prefix: UpdateApi
                - prefix: DeleteApi
          Name: glint-aws-exporter-sync-apigateway-api-trails
          State: ENABLED
          Targets:
            - Id: GlintAWSExporterEventsQueue
              Arn:
...
In this step-by-step example, you will export your `Cloudfront distributions` to Glint.
...
1. Deploy the Glint AWS exporter and the event rule in the `us-east-1` region.
2. Create a trail that will capture global service events in the same region that you've deployed the Glint AWS exporter.
    ...
    Resources:
      EventRule0:
        ...
        Properties:
          ...
          Name: glint-aws-exporter-sync-cloudfront-trails
          State: ENABLED
          Targets:
            - Id: GlintAWSExporterEventsQueue
              Arn:
...
In this step-by-step example, you will export your `DynamoDB tables` to Glint.
         ...
         EventPattern:
           ...
           detail:
             ...
             eventName:
               ...
               - prefix: UntagResource
               - prefix: DeleteTable
         Name: glint-aws-exporter-sync-dynamodb-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your `RDS instances` to Glint.
   ...
   Resources:
     EventRule0:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-rds-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your `Step Functions state machines` to Glint.
   ...
   Resources:
     EventRule0:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-stepfunctions-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your `Elastic Beanstalk applications and environments` to Glint.
   ...
   Resources:
     EventRule0:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-beanstalk-apps-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
     ...
     EventRule1:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-beanstalk-envs-events
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your `CloudFormation Stacks` to Glint.
       ...
       "properties": {
         ...
         "status": {
           ...
           "enum": [
             ...
             "IMGLINT_IN_PROGRESS",
             "IMGLINT_COMPLETE",
             "IMGLINT_ROLLBACK_IN_PROGRESS",
             "IMGLINT_ROLLBACK_FAILED",
             "IMGLINT_ROLLBACK_COMPLETE"
           ],
           "enumColors": {
     ...
     EventPattern:
       ...
       detail:
         ...
         eventName:
           ...
           - prefix: UpdateStack
           - prefix: DeleteStack
     Name: glint-aws-exporter-sync-cloudformation-trails
     State: ENABLED
     Targets:
       - Id: GlintAWSExporterEventsQueue
         Arn:
   ...
   EventRule1:
     ...
     Properties:
       ...
       EventPattern:
         ...
         source:
           - aws.cloudformation
       Name: glint-aws-exporter-sync-cloudformation-status-change-trails
       State: ENABLED
       Targets:
         - Id: GlintAWSExporterEventsQueue
           Arn:
...
In this step-by-step example, you will export your `EC2 instances` to Glint.
         ...
         EventPattern:
           ...
           detail:
             ...
             eventName:
               - prefix: DeleteTags
               - prefix: CreateTags
         Name: glint-aws-exporter-sync-ec2-tags-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
     ...
     EC2InstanceStateChangeEventRule:
       ...
       Properties:
         ...
         EventPattern:
           ...
           source:
             - aws.ec2
         Name: glint-aws-exporter-sync-ec2-instance-status-change-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your `Load balancers` to Glint.
   ...
   Resources:
     LoadBalancerCreateEventRule:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-elb-create-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
     ...
     LoadBalancerUpdateEventRule:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-elb-update-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
         ...
         EventPattern:
           ...
           detail:
             ...
             eventName:
               - prefix: RemoveTags
               - prefix: AddTags
         Name: glint-aws-exporter-sync-elb-tags-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
     ...
     LoadBalancerUpsertListenersEventRule:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-elb-upsert-listener-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
     ...
     LoadBalancerDeleteListenersEventRule:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-elb-delete-listener-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your `EKS clusters` to Glint.
         ...
         EventPattern:
           ...
           detail:
             ...
             eventName:
               - prefix: CreateCluster
               - prefix: DeleteCluster
         Name: glint-aws-exporter-sync-eks-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your `ECR repositories` to Glint.
   ...
   Resources:
     ECRRepositoryEventRule:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-ecr-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
         ...
         EventPattern:
           ...
           detail:
             ...
             eventName:
               - prefix: TagResource
               - prefix: UntagResource
         Name: glint-aws-exporter-sync-ecr-tags-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
### Using Python script
Alternatively you can use a Python script to export your ECR repositories and images to Glint. The script is available in the [example-ecr-images](https://github.com/kozmoai/example-ecr-images) repository.

## Elasticache serverless cache

In this step-by-step example, you will export your `Serverless cache` to Glint.
   ...
   Resources:
     ElasticacheEventRule:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-serverless-cache-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
         ...
         EventPattern:
           ...
           detail:
             ...
             eventName:
               - prefix: AddTagsToResource
               - prefix: RemoveTagsFromResource
         Name: glint-aws-exporter-sync-serverless-cache-tags-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your `Cache clusters` to Glint.
   ...
   Resources:
     ElasticacheEventRule:
       ...
       Properties:
         ...
         Name: glint-aws-exporter-sync-cache-cluster-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
         ...
         EventPattern:
           ...
           detail:
             ...
             eventName:
               - prefix: AddTagsToResource
               - prefix: RemoveTagsFromResource
         Name: glint-aws-exporter-sync-cache-cluster-tags-trails
         State: ENABLED
         Targets:
           - Id: GlintAWSExporterEventsQueue
             Arn:
...
In this step-by-step example, you will export your EC2 `Auto scaling groups` to Glint.
   ...
   Resources:
    AutoScalingGroupEventRule:
      ...
      Properties:
        ...
        Name: glint-aws-exporter-sync-auto-scaling-group-trails
        State: ENABLED
        Targets:
          - Id: GlintAWSExporterEventsQueue
            Arn:
        ...
        EventPattern:
          ...
          detail:
            ...
            eventName:
              ...
              - prefix: DeleteTags
        Name: glint-aws-exporter-sync-auto-scaling-group-tags-trails
        State: ENABLED
        Targets:
          - Id: GlintAWSExporterEventsQueue
            Arn:
...
:::tip Prerequisite
This guide assumes that you have ingested S3 buckets into Glint using the `terraform` option of the [AWS exporter](/build-your-software-catalog/sync-data-to-catalog/cloud-providers/aws/Installation#terraform-installation-recommended).
:::

### Ingest Services from GitHub.

Follow this [guide](https://docs.useglint.io/build-your-software-catalog/sync-data-to-catalog/git/github/installation) to ingest your GitHub repositories into Glint. Glint will create a `service` blueprint that you will be using subsequently.
...
Your [data model](https://app.useglint.io/dev-portal/data-model) should now contain the `Service` blueprint:
...
Now that Glint is synced with your `s3_bucket` and `service` blueprints, let's map the two together.
...
2. In the [Glint AWS exporter repository](https://github.com/kozmoai/template-assets) you cloned during the [ingestion step](/build-your-software-catalog/sync-data-to-catalog/cloud-providers/aws/Installation/#terraform-installation-recommended), go to the `template-assets/aws/s3_bucket` folder. We are going to add a relation from our S3 bucket configuration to the `Service` blueprint by editing two files:
...
resource "kozmoai_blueprint" "s3_bucket" {
  title      = "S3 Bucket"
  icon       = "Bucket"
...
You can view the relation in your [data model](https://app.useglint.io/dev-portal/data-model)
...
Now go to your [catalog](https://app.useglint.io/s3_buckets), and click on the S3 bucket you used in this guide. You will see it connected to the service.
