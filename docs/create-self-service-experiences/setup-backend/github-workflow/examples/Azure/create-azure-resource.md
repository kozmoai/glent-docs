...
1. Create the following GitHub Action secrets:
    1. Create the following Glint credentials:
...
<br />
3. Create a Glint <GlintTooltip id="blueprint">blueprint</GlintTooltip> with the following JSON definition:

<details>
   <summary>Glint Blueprint: Azure Storage Account</summary>
   :::note
...
<details>
  ...
  <summary>Glint Action: Create Azure Storage</summary>
   :::tip
    ...
    steps:
      ...
      - name: Run Terraform Plan and Apply (Azure)
        ...
        env: 
            ...
            TF_VAR_port_client_id: ${{ secrets.GLINT_CLIENT_ID }}
            TF_VAR_port_client_secret: ${{ secrets.GLINT_CLIENT_SECRET }}
      ...
      - name: Run Terraform Plan and Apply (Glint)
        id: plan-glint
        env: 
            ARM_CLIENT_ID: ${{ secrets.ARM_CLIENT_ID }}
            ARM_CLIENT_SECRET: ${{ secrets.ARM_CLIENT_SECRET }}
      ...
      - name: Terraform Glint Status
        if: steps.plan-glint.outcome == 'failure'
        run: exit 1
