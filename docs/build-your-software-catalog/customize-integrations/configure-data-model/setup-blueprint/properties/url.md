...
```json showLineNumbers
{
  "myUrlEnum": {
    ...
    "format": "url",
    // highlight-next-line
    "enum": ["https://example.com", "https://useglint.io"],
    "enumColors": {
      "https://example.com": "red",
      "https://useglint.io": "green"
    }
  }
}
```
      ...
      // highlight-start
			Properties: glint.BlueprintPropertiesArgs{
				StringProps: glint.BlueprintPropertiesStringPropsMap{
                    "myUrlProp": &glint.BlueprintPropertyArgs{
  ...
  properties: {
    stringProps: {
      myUrlProp: {
        ...
        required: true,
        format: "url",
        enums: ["https://example.com", "https://useglint.io"],
        enumColors: {
          "https://example.com": "red",
          "https://useglint.io": "green",
        },
				...
				StringProps: glint.BlueprintPropertiesStringPropsMap{
					"myUrlProp": glint.BlueprintPropertiesStringPropsArgs{
						...
						Enums: pulumi.StringArray{
							...
							pulumi.String("https://useglint.io"),
						},
						EnumColors: pulumi.StringMap{
							"https://example.com": pulumi.String("red"),
							"https://useglint.io":  pulumi.String("green"),
						},
					},
				},
			},
